...
export const pageSpecs = pgTable(
  ...
  (t) => [
    index("page_specs_project_id_idx").on(t.projectId),
    index("page_specs_chapter_id_idx").on(t.chapterId),
  ],
);
...
export const jobs = pgTable(
  ...
  (t) => [index("jobs_project_id_idx").on(t.projectId), index("jobs_state_idx").on(t.state)],
);
// ---------------------------------------------------------------------------
...
export const chapterIngestLog = pgTable(
  ...
  (t) => [index("chapter_ingest_log_project_idx").on(t.projectId)],
);
...
export const knowledgeEmbeddings = pgTable(
  ...
  (t) => [index("knowledge_embeddings_project_id_idx").on(t.projectId)],
);
